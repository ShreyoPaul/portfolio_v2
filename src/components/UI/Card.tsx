...
const Card = (project: Project) => {
    return (
        <div className='md:w-[300px] md:h-[180px] sm:w-[400px] sm:h-[240px] w-[80vw] h-[45vw] overflow-hidden rounded-md group drop-shadow-xl bg-slate-400'>
            ...
            <div className='px-4 py-4 md:py-2 relative duration-300 md:group-hover:-translate-y-16 sm:group-hover:-translate-y-18 group-hover:-translate-y-18 sm:top-0 -top-[18px] bg-basic-purple'>
